...
$lati=$_GET['latitude']; //koordinat latitude lokasi lampu
$longi=$_GET['longitude']; //koordinat longitude lokasi lampu
$latuser=$_GET['lat'];  //koordinat latitude lokasi petugas
$longiuser=$_GET['lng'];   //koordinat longitude lokasi petugas
}
?>
...
var mbAttr	= 'Map data &copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors, ' +
	...
	<?php if (isset($_GET['pelapor'])) { 

		$lat=$_GET['lat']; //lokasi latitude pelapor
	    $lng=$_GET['lng']; //lokasi longitude pelapor
	?>
		var map = L.map('mapid', {
		center: [<?=$lat ?>, <?=$lng ?>],
		zoom: 16,
