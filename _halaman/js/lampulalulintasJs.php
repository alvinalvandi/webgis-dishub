...
// marker normal
$url='laporkan';
$id_statusnormal=1; //normal
$id_statusrusak=6; //rusak
$id_statusperbaikan=2; //sedang diperbaiki
...
var myIcon = L.icon({
		...
		var tombol = 'Lokasi : <?=$row->alamat?><br>Kondisi: <?=$row->nama_status?><br><br>'+'<a href="<?=url($url.'&lapor&id='.$row->id_lampu)?>" target="_BLANK">'
	    			+'<button class="btn btn-warning btn-sm" ><i class="fa fa-exclamation-circle"></i> Laporkan</button></a>';
