...
function input_text($a, $b, $c = '', $d = '')
{
    if(!is_array($c)){
        ...
        return '<input type="text" id="'.$c.'" name="' . $a . '" value="' . $b . '" class="form-control"' . $d . ' required >' . "\n";
    }
    else{
        $set='';
        ...
        $c=$set;
        return '<input type="text" id="'.$c.'" name="' . $a . '" value="' . $b . '" required>' . "\n";
...
function input_file($a, $b, $c = '', $d = '')
{
    ...
    return '<input type="file" id="file" name="' . $a . '" value="' . $b . '" class="form-control' . $c . '"' . $d . ' required>' . "\n";
}
...
function input_date($a, $b, $c = '', $d = '')
{
    ...
    return '<input type="hidden" name="' . $a . '" value="' . $b . '" class="form-control' . $c . '"' . $d . '>' . "\n";
}
...
function textarea($a, $b, $c = '', $d = '')
{
    if(!is_array($c)){
        ...
        return '<textarea id="area" name="' . $a . '" class="form-control' . $c . '"' . $d . ' required max="250">' . $b . '</textarea>' . "\n";
    }
    else{
        $set='';
        foreach ($c as $key => $value) {
...
function input_email($a, $b, $c = '', $d = '')
{
    ...
    return '<input type="email" name="' . $a . '" value="' . $b . '" class="form-control' . $c . '"' . $d . ' required>';
}
...
function select($a, $b = array(), $c = array(), $d = '', $e = '')
{
    if(!is_array($d)){
        ...
        return '<select name="' . $a . '" class="form-control' . $d . '"' . $e . ' required>' . "\n" . $data . "\t\t\t\t\t" . '</select>' . "\n\t\t\t\t";
    }
    else{
        $set='';
